        ...
        public override void Create()
        {
            ...
            anims.Add(
                (
                    new HorizontalTextAnimation()
                    {
                        Text = "The ship is under attack!",
                        Origin = new Point(10, 22),
                        Color = 7,
                        Speed = 1,
                        IsPaused = true,
                    },
            ...
            anims.Add(
                (
                    new HorizontalTextAnimation()
                    {
                        Text = "Grabons are here! It's a trap!",
                        Origin = new Point(10, 22),
                        Color = 7,
                        Speed = 1,
                        IsPaused = true,
            ...
            anims.Add(
                (
                    new HorizontalTextAnimation()
                    {
                        Text = "HULL INTEGRITY BREACH!",
                        Origin = new Point(10, 25),
                        Color = 12,
                        Speed = 1,
                        IsPaused = true,
                    },
            ...
            anims.Add(
                (
                    new HorizontalTextAnimation()
                    {
                        Text = "Wake up, commander!",
                        Origin = new Point(20, 30),
                        Color = 7,
                        Speed = 1,
                        IsPaused = true,
                    },
            ...
            anims.Add(
                (
                    new HorizontalTextAnimation()
                    {
                        Text = "Wake up, Remiligius, for the god's sake!",
                        Origin = new Point(20, 34),
                        Color = 7,
                        Speed = 2,
                        IsPaused = true,
                    },
            ...
            anims.Add(
                (
                    new HorizontalTextAnimation()
                    {
                        Text = "The ship has been attacked! Our astronauts are floating in space!",
                        Origin = new Point(20, 37),
                        Color = 7,
                        Speed = 2,
                        IsPaused = true,
                    },
            ...
            anims.Add(
                (
                    new HorizontalTextAnimation()
                    {
                        Text = "Switching to the sensors package from 1981.",
