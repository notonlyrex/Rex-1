...
namespace RexMinus1.Levels
{
    internal class Two : Level
    {
        ...
        public override void Start()
        {
            ...
            models.Add(new Mine { Position = new Vector3(0, 0, 50), RotationX = 1.241f });

            models.Add(new Mine { Position = new Vector3(0, 0, 100), RotationX = 2.11f });

            models.Add(new Mine { Position = new Vector3(0, 0, 300), RotationX = 3.41f });
